This simple program takes the .tsv file supplied by IMDB and uses it to search and generate graphs and data from the very long list  of actors and actresses included in the .txt.
